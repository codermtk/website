...
function FloatingPaths({ position }: { position: number }) {
  ...
  return (
    <div className="absolute inset-0 pointer-events-none">
      <svg className="w-full h-full text-white dark:text-black" viewBox="0 0 696 316" fill="none">
...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-black dark:bg-white">
